---
layout: post
title:  "The Research Directions and the Ideas: Kyoto Draft"
...
+ Hybrid automata as system models and refinement to ROS programs and the simulation engine
  - The reaction module is the abstraction of ROS programs.
    ...
    because KPN can be analyzed independently of communication delay
